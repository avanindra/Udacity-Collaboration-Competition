...
from tennisagent import Agent, ReplayBuffer
# from tennismemory import ReplayMemory
...
class args:
    ...
    game =  "C:/projects/deep-reinforcement-learning/p3_collab-compet/Tennis_Windows_x86_64/Tennis.exe" # Udacity environment        
